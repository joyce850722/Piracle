...
public class openppt extends AppCompatActivity
    ...
    private static final String BUTTON_TEXT = "Call Google Slides API";
    private static final String PREF_ACCOUNT_NAME = "accountName";
    private static final String[] SCOPES = { SlidesScopes.PRESENTATIONS_READONLY };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress.setMessage("Calling Google Slides API ...");
    ...
    /**
     * An asynchronous task that handles the Google Slides API call.
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        /**
         * Background task to call Google Slides API.
        ...
        /**
         * Returns the number of elements on each slide of a sample presentation:
         * https://docs.google.com/presentation/d/1EAYk18WDjIG-zp_0vLm3CsfQh_i8eXc67Jo2O9C6Vuc/edit
         * @return List of slides and elements.
         * @throws IOException
         */
        private List<String> getDataFromApi() throws IOException {
            ...
            for (int i = 0; i < slides.size(); i++) {
                ...
                results.add(String.format("Slide #%d contains %d elements.", i + 1,
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                output.add(0, "Data retrieved using the Google Slides API:");
